...
Palimpsest uses a single-context domain layout.

Before exploring or changing the product:

1. Read `CONTEXT.md` and use its vocabulary in code, issues, tests, and docs.
2. Read the ADRs under `docs/adr/` that touch the change.
